      ...
      <div class="left-half">
        ...
        <ul class="geek-slide">
          <li>
            ...
            <span class="description">想买就买，多种书籍任你选择</span>
          </li>
          <li>
...
.login-page {
  width: 100%;
  height: 100vh;
  background: #5dd5c8 url(../../assets/img/bgimg.png) center bottom no-repeat;
...
.login-page .login-box {
  ...
  height: 450px; /* 修改后的高度 */
  padding: 0;
  background: rgba(255, 255, 255, 0.8); /* 修改后的透明度 */
